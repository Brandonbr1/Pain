...
public class PainGenLayerZoom extends PainGenLayer
{
    public PainGenLayerZoom(long p_i2134_1_, PainGenLayer p_i2134_3_)
    {
        super(p_i2134_1_);
     ...
     */
    public static PainGenLayer magnify(long p_75915_0_, PainGenLayer p_75915_2_, int p_75915_3_)
    {
        Object object = p_75915_2_;

        for (int k = 0; k < p_75915_3_; ++k)
        {
            object = new PainGenLayerZoom(p_75915_0_ + (long)k, (PainGenLayer)object);
        }

        return (PainGenLayer)object;
    }
}